...
export function NewProjectModal({
  ...
  return (
    ...
    >
      <div
        className="flex max-h-[85vh] w-full max-w-5xl flex-col overflow-hidden rounded-xl border border-border bg-card"
          ...
          <div className="overflow-y-auto p-4">
            ...
            <div className="grid grid-cols-2 gap-2 lg:grid-cols-3">
              {TEMPLATES.map((t) => (
                ...
                >
                  <div className="flex h-20 w-full items-center justify-center rounded bg-muted text-3xl">
                    {t.thumbnail}
                  </div>
