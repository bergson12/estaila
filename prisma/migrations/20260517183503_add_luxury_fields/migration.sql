...
INSERT INTO "new_Property" ("address", "bathrooms", "bedrooms", "category", "createdAt", "description", "featuredPhoto", "id", "location", "mapsUrl", "metersSquared", "operation", "ownerId", "parking", "priceDOP", "priceUSD", "status", "title", "updatedAt", "userId") SELECT "address", "bathrooms", "bedrooms", "category", "createdAt", "description", "featuredPhoto", "id", "location", "mapsUrl", "metersSquared", "operation", "ownerId", "parking", "priceDOP", "priceUSD", "status", "title", "updatedAt", "userId" FROM "Property";
DROP TABLE "Property";
